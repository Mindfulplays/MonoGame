...
public class ExternalTool
{
    ...
    public static int Run(string command, string arguments, out string stdout, out string stderr, string stdin = null)
    {
        ...
        Console.WriteLine($"Running command: {fullPath} {arguments}");
        ...
        using (var process = new Process())
        {
            ...
            if (stdin != null) { process.StandardInput.Write(System.Text.Encoding.ASCII.GetBytes(stdin)); }
    ...
    private static string FindCommand(string command)
    {
        ...
        // ***************** NOTE ************************
        // TODO(perumaal): Changed the order of PATH-based tools to be ahead of built-in tools.
        // This helps us `brew install ffmpeg/ffprobe` on Mac (Arm) - built-in ffprobe doesn't quite work.
        // ***************** NOTE ************************
        ...
        // TODO(perumaal): Changed the order of PATH-based tools to be ahead of built-in tools.
        // This helps us `brew install ffmpeg/ffprobe` on Mac (Arm) - built-in ffprobe doesn't quite work.
        // The following used to be before the first note up above ^.
        // ***************** NOTE ************************
