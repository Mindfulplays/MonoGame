...
#region GameWindow Members
        ...
        // Client bounds are updated either on start or when the orientation changes.
        // Tablets do have a way to manage windows creatively, so :
        // TODO: Ensure client bounds are updated accordingly.
        private Rectangle _clientBounds;
        public override Rectangle ClientBounds => _clientBounds;

        internal Rectangle _UpdateClientBounds()
        {
            ...
            if (_viewController is iOSGameViewController)
            {
                ...
                _clientBounds = new Rectangle((int)(bounds.X * scale), (int)(bounds.Y * scale), width, height);
            }
            else
            {
        ...
        {
            throw new NotImplementedException("screen change");
        }
